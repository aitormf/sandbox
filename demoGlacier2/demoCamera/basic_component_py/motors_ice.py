...
if 'SetterMotors' not in _M_jderobot.__dict__:
    ...
    SetterMotors._op_setMotors = IcePy.Operation('setMotors', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_jderobot._t_MotorsPrx, False, 0),), (), None, ())
